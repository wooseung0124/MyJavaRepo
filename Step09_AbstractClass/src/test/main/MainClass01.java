 ...
 * - 추상클래스 type의 참조값이 필요하다면 추상클래스를 상속받은 자식 클래스를 정의해서 객체 생성한다.
 * - 추상클래스를 상속받은 자식 클래스는 부모의 추상메소드를 모두 오버라이드(재정의)해야한다.
 */
...
public static void main(String[] args) {
	...
	//Weapon 추상클래스를 상속받은 mYWeapon클래스로 객체를 생성해서 Weapon type 의 참조값을 얻어내기
